...
var averageChange = 0;
totalChange = 0;
var greatesIncreaseValue = 0;
var greatestIncreaseMonth;
var greatesDecreaseValue = 0;
var greatestDecreaseMonth;

for (var i = 0; i < finances.length; i++) {
  //getting total value of finances.
  //due that this is 2 dimensional array. we access with for loop each "row" and access 2nd element in this array
  ...
  if (i < finances.length - 1) {
    ...
    //getting total changes in finances for each month compared against previous month
